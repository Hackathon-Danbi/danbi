...
export const FACE_CAPTURE_HELP = {
  entry: '얼굴을 네 장 찍어요. 정면, 오른쪽, 왼쪽, 다시 정면 순서로 「얼굴 찍기」를 눌러주세요.',
  ...
  openCoach: '타원에 얼굴을 맞추고, 귀와 턱선을 확인해 주세요. 단비가 도와드릴게요.',
};
...
export const FACE_COACH_STEPS: Record<FaceHelpKind, string[]> = {
  ...
  distance: [
    '휴대폰을 눈높이로 들어 주세요.',
    '얼굴이 노란 타원 안에 다 들어오게 조금 멀리 해 주세요.',
    '좋아요. 턱선을 아래 선에 맞추고 찍어 주세요.',
  ],
  full: [
    '밝은 곳에서 화면을 정면으로 봐 주세요.',
    '양쪽 귀가 타원 옆에 보이게 해 주세요.',
    '좋아요. 턱선을 맞추고 아래 얼굴 찍기를 눌러주세요.',
  ],
};
